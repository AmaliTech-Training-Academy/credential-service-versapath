    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/badges/my-badges/**").hasRole("LEARNER")
                        .requestMatchers("/api/v1/badges/learner/**").hasAnyRole("INSTRUCTOR", "ADMIN", "LEARNER")
                        .requestMatchers("/api/v1/badges/verify/**").permitAll()
